...
// Daca verificarea existentei unei chei si scrierea unei valori corespunzatoare acesteia nu se executa atomic,
// apare un race condition la scrierea in HashMap.
//Solutia este sa se foloseasca putIfAbsent(), care este o metoda sincronizata.
// Doar daca aceasta metoda returneaza null (exista deja un element cu cheia respectiva) se va folosi put()-ul clasic.
public class Main {
