...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < N_ITERATIONS; i++) {
            // Folosim lista sincronizata
            List<Integer> list = Collections.synchronizedList(new ArrayList<>());
            // Folosim un semafor initializat cu -2 pe care fiecare thread care scrie il incrementeaza,
            // iar cel care sorteaza il decrementeaza.
